...
const Shop = () => {
  return (
    <div className='max-w-5xl text-center mt-10'>
      ...
      <br/>
      <h1 className=" font-inter font-extrabold text-6xl">This is a <span className=" text-pink-400">Shop</span> page</h1>
      ...
      <div className='flex align-center justify-between flex-row mt-8 gap-10 p-4 text-left'>
        <div className='bg-white w-64'>
          <Image src="/cr7_phone.jpg" width={300} height={300} className='bg-gray-400'/>
          <p className='text-black font-bold text-xl pl-4 pt-4'>BIG FONT</p>
          <p className='text-black pl-4 pb-4'>small font</p>
        </div>
        ...
        <div className='bg-white w-64'>
          <Image src="/cr7_inverse.jpg" width={300} height={300} className='bg-gray-400'/>
          <p className='text-black font-bold text-xl pl-4 pt-4'>BIG FONT</p>
          <p className='text-black pl-4 pb-4'>small font</p>
        </div>

        <div className='bg-white w-64'>
          <Image src="/nyc_phone.jpg" width={300} height={300} className='bg-gray-400'/>
          <p className='text-black font-bold text-xl pl-4 pt-4'>BIG FONT</p>
          <p className='text-black pl-4 pb-4'>small font</p>
        </div>
      </div>
